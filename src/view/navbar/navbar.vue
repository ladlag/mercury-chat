<!-- src/view/navbar/navbar.vue（如你已有就不改；这里给完整可替换版，保持你现有结构/样式） -->
<template>
  <div class="navbar-container">
    <div class="navbar-top">
      ...
      >
        <div class="chat-icon-box" :class="{ active: isActive(item) }">
          <img :src="item.icon" />
        </div>
...
import { activeCapabilityId, useNavbarItems } from "@/config/navbar-top.config";

const navbarItems = useNavbarItems();

const isActive = (item: any) => activeCapabilityId.value === item.id;
